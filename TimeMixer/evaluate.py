import torch
from models.backbone import BackboneTimeMixer
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Evaluate BackboneTimeMixer on UCI-HAR Dataset')
    parser.add_argument('--data_dir', type=str, default='data/UCI_HAR_Dataset', help='Path to dataset')
    parser.add_argument('--model_path', type=str, default='time_mixer.pth', help='Path to saved model')
