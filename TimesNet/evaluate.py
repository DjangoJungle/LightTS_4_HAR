import torch
from models.backbone import BackboneTimesNet
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Evaluate BackboneTimesNet on UCI-HAR Dataset')
    parser.add_argument('--data_dir', type=str, default='data/UCI_HAR_Dataset', help='Path to dataset')
    parser.add_argument('--model_path', type=str, default='times_net.pth', help='Path to saved model')
